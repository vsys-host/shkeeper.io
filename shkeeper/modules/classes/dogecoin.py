...
class Dogecoin(Crypto):
    ...
    def get_rpc_credentials(self):
        username = 'dogecoind-rpc'; #environ.get(f"{self.crypto}_USERNAME", "shkeeper")
        password = 'dogecoind-rpc'; #environ.get(f"{self.crypto}_PASSWORD", "shkeeper")
