...
function build_filter_args() {
    ...
    [
        ...
        {element_name: "address-input", arg_name: "dest_addr"},
        {element_name: "coinAmount", arg_name: "amount"},
    ].forEach((e) => {
...
function update_tx_table(page=1) {
    ...
    document.querySelector('#report-download').href = `/parts/payouts?${report_download_args}`;
    ...
    fetch(`/parts/payouts?${args}`).then(function (response) {
